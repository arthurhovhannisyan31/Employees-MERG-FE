...
import { EmployeeSchema } from '_/containers/Employee/components/DetailsModal/types'
// helpers
import { ADULT_AGE } from '_/constants/common'
...
export const validationSchema: yup.SchemaOf<EmployeeSchema> = yup
  .object()
  .shape({
    title: yup
      .string()
